/*
this is the stored procedure silver layer that contains a ETL process extract tarnsform load 
here extracting datas from bronze layer  and transforming the datas and loading to silver layer 
*/
